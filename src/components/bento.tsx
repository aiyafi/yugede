...
const SkeletonFive = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-xs text-neutral-500">Lorem ipsum dolor sit amet</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>
    </motion.div>
  );
...
const items = [
  {
    title: "Bye monggo gawe acara dewe bos",
    description: (
